class CfgExileCustomCode 
{
	...
	ExileClient_gui_modelBox_destroy = "fixes\ExileClient_gui_modelBox_destroy.sqf";
	ExileClient_gui_modelBox_update = "fixes\ExileClient_gui_modelBox_update.sqf";
	...
	ExileClient_object_player_parachuteFix = "fixes\ExileClient_object_player_parachuteFix.sqf";
