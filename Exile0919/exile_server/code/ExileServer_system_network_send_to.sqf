...
{
	[_messageName, _messageParameters] remoteExecCall ['ExileClient_system_network_dispatchIncomingMessage',_player];
}
else
{
	[_messageName, _messageParameters] remoteExecCall ['ExileClient_system_network_dispatchIncomingMessage',owner _player];
};